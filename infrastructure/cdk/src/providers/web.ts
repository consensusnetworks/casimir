...
export class WebStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: WebStackProps) {
    ...
    /** Create a bucket for the web app */
    ...
    /** Create a cloudfront distribution for the web app */
    ...
    /** Deploy the web app to the bucket */
    ...
    /** Create an A record for the web app subdomain */
