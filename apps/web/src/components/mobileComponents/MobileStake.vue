...
const handleOutsideClick = (event: any) => {
  const mobileSelectWalletInputContainer = document.getElementById('mobileSelectWalletInputContainer')
  const mobileSelectWalletOptionsCard = document.getElementById('mobileSelectWalletOptionsCard')
  const mobileSelectWalletInputButton = document.getElementById('mobileSelectWalletInputButton')
  if (mobileSelectWalletInputContainer && mobileSelectWalletOptionsCard && mobileSelectWalletInputButton) {
    if (openSelectWalletInput.value) {
      if (!mobileSelectWalletInputContainer.contains(event.target)) {
        if (!mobileSelectWalletInputButton.contains(event.target)) {
  ...
  const mobileTermsOfServiceContainer = document.getElementById('mobileTermsOfServiceContainer')
  const mobileTermsOfServiceCard = document.getElementById('mobileTermsOfServiceCard')
  const mobileTermsOfServiceButton = document.getElementById('mobileTermsOfServiceButton')


  if (mobileTermsOfServiceCard && mobileTermsOfServiceButton && mobileTermsOfServiceContainer) {
    if (openTermsOfService.value) {
      if (!mobileTermsOfServiceCard.contains(event.target)) {
        if (!mobileTermsOfServiceButton.contains(event.target)) {
...
<template>
  <div
    class="h-full w-full bg-white relative px-[20px] pt-[15px] pb-[70px]"
  >
    <!-- <div
      v-if="stakingActionLoader"
      class="absolute w-full h-full bg-black/[.1] top-0 left-0 rounded-[3px] z-[10] flex items-center justify-center"
    >
    ...
    <div class="card_input text-black mb-[22px] relative">
      <button
        id="mobileSelectWalletInputButton"
      ...
      <div
        ...
        id="mobileSelectWalletInputContainer"
      ...
      >
        ...
        <div
          ...
          id="mobileSelectWalletOptionsCard"
          :key="item.provider"
