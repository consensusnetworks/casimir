...
<template>
  <div class="h-[100vh] overflow-hidden">
    <div class="h-full flex flex-col sr-only noscreen:not-sr-only ">
    ...
    <div class="not-sr-only noscreen:sr-only h-full w-full flex flex-col justify-center items-center text-center px-20">
      <i
