  ...
  <div>
    <nav class="nav">
      <div class="nav__container">
        ...
        <ul class="nav__links">
          ...
          <li><a href="https://consensusnetworks.com">Company</a></li>
        </ul>
      </div>
    </nav>
    ...
    <!-- <section class="events">
      <div class="events__text">
        <h2 class="text-4">
          Casimir relies on a highly available managed <br />
          Etheruem nodes capable of serving millions of <br />
          concurrent requests and analytics.
        </h2>
        <div>
    ...
    <section class="faq">
      ...
      <div class="faq__container">
        <div class="faq__item">
          <span class="text-7">What&apos;s the minimum I can stake?</span>
          <span class="text-r">There is no minimum! However, there is a point at which gas fees
            make very small amounts staked not worth it.
          </span>
        </div>

        <div class="faq__item">
          <span class="text-7">How does Casimir work? </span>
          <span class="text-r">Casimir uses distributed validator technology (DVT) to pool users'
        ...
        <div class="faq__item">
          <span class="text-7">How are rewards generated?</span>
          <span class="text-r">Casimir's smart contracts combine your ETH into pools of 32 ETH
        ...
        <div class="faq__item">
          <span class="text-7">What does it mean to create an account? </span>
          <span class="text-r">
        ...
        <div class="faq__item">
          <span class="text-7">What are the advantages of staking with Casimir over other
            protocols?</span>
          <span class="text-r">Casimir maximizes rewards while minimizing risks. It enables users
        ...
        <div class="faq__item">
          <span class="text-7">What are the risks? </span>
          <span class="text-r">
        ...
        <!-- 6 -->
        <div class="faq__item">
          <span class="text-7">Who is behind Casimir? Are the smart contracts open source and
            audited?</span>
          <span class="text-r">
        ...
        <div class="faq__item">
          <span class="text-7">What is Distributed Validator Technology (DVT)?</span>
          <span class="text-r">DVT enhances Ethereum's validation layer by distributing validator
        ...
        <div class="faq__item">
          <span class="text-7">Why don’t you use a Liquid Staking Derivatives (LSDs) or Liquid
            Staking Tokens (LSTs)?</span>
          <span class="text-r">LSDs come with inherent risks, notably counterparty risks. As LSDs
        ...
        <div class="faq__item">
          <span class="text-7">Where are my rewards distributed, is there a secondary token?</span>
          <span class="text-r">Your rewards will be distributed to the wallet you staked with; you
        ...
        <div class="faq__item">
          ...
          <span class="text-r">
            ...
            >WalletConnect protocol</a>.
          </span>
        </div>

        <div class="faq__item">
          <span class="text-7">Is there a lockup period or waiting period for withdrawals?</span>
          <span class="text-r">Since you are staking native ETH, there may be a wait time for a
        ...
        <div class="faq__item">
          ...
          <span class="text-r">Casimir is launching with a small set of vatted validator partners,
        ...
        <div class="faq__item">
          ...
          <span class="text-r">The Casimir smart contract charges a user a 5% fee on deposits and
      ...
      <div class="roadmap__container">
        ...
        <div class="roadmap__item__container">
          <div class="roadmap__item done">
            <div class="roadmap__item__point"></div>
          ...
          <div class="roadmap__item">
            <div class="roadmap__item__point"></div>
            <span class="highlight">Liquid Withdrawal Pools</span>
          </div>
        </div>
      </div>
    </section> -->
    ...
    <!-- <section class="newsletter">
      <span class="text-7 bold"
        >Subscribe to get the latest release <br />information and blogs</span
      >
      <div>
        <input
          type="email"
          ...
          id="newsletter-input"
        />
        <button id="newsletter-submit" class="btn-secondary">Subscribe</button>
      </div>
    </section> -->

    <section class="footer">
      <span class="c">© 2021 Casimir. All rights reserved.</span>
      <ul>
        <li>
          <a href="https://api.casimir.co">API Reference</a>
        </li>
        <li><a href="/">Discord</a></li>
        <li>
          <a href="https://github.com/consensusnetworks/casimir">GitHub</a>
        </li>
