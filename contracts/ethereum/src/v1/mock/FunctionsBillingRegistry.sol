...
import "@chainlink/contracts/src/v0.8/dev/interfaces/FunctionsBillingRegistryInterface.sol";
...
import "@chainlink/contracts/src/v0.8/dev/interfaces/AuthorizedOriginReceiverInterface.sol";
import "@chainlink/contracts/src/v0.8/ConfirmedOwner.sol";
import "@chainlink/contracts/src/v0.8/dev/AuthorizedReceiver.sol";
import "@chainlink/contracts/src/v0.8/dev/vendor/openzeppelin-solidity/v.4.8.0/contracts/utils/SafeCast.sol";
import "@chainlink/contracts/src/v0.8/dev/vendor/openzeppelin-solidity/v.4.8.0/contracts/security/Pausable.sol";
    ...
    AuthorizedReceiver
{
    ...
    AuthorizedReceiverInterface private immutable ORACLE_WITH_ALLOWLIST;
    ...
    constructor(address link, address linkEthFeed, address oracle) ConfirmedOwner(msg.sender) {
        LINK = LinkTokenInterface(link);
        LINK_ETH_FEED = AggregatorV3Interface(linkEthFeed);
        ORACLE_WITH_ALLOWLIST = AuthorizedReceiverInterface(oracle);
    }
