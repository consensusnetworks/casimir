...
contract FunctionsOracle is FunctionsOracleInterface, OCR2Base, AuthorizedReceiver {
    ...
    function estimateCost(
        ...
        FunctionsBillingRegistryInterface.RequestBilling memory billing = FunctionsBillingRegistryInterface
            .RequestBilling(subscriptionId, msg.sender, gasLimit, gasPrice);
